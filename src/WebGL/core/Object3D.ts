...
export class Scene extends Object3D {
    ...
    __addObject<T extends Object3D>(object: T) {
        ...
        if (object instanceof Light) {
            if (this.__lights.indexOf(object as unknown as Light) === -1)
                this.__lights.push(object as unknown as Light);

            //TODO: Do I need this??
            if (
                (object as unknown as Light).target &&
                (object as unknown as Light).target.parent === undefined
            )
